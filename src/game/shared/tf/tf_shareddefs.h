...
enum ETFCond
{
	...
	TF_COND_AFTERBURN_IMMUNE                 = 75,
	TF_COND_SWIMMING_NO_EFFECTS              = 76, // =87_DNOC_FT
	TF_COND_PURGATORY                        = 77,
	TF_COND_PLAGUE                           = 78,
	TF_COND_KING_BUFFED                      = 79,
	TF_COND_TEAM_GLOWS                       = 80, // used to show team glows to living players
	TF_COND_KNOCKED_INTO_AIR                 = 81,
	TF_COND_COMPETITIVE_WINNER               = 82,
	TF_COND_COMPETITIVE_LOSER                = 83,
	TF_COND_HEALING_DEBUFF                   = 84,
	...
	TF_COND_AIR_CURRENT                      = 86,
	TF_COND_HALLOWEEN_HELL_HEAL              = 87,
	TF_COND_IMMUNE_TO_PUSHBACK				 = 88,
		//
	// ADD NEW ITEMS HERE TO AVOID BREAKING DEMOS
	//
...
#define ACHIEVEMENT_TF_DOMINATE_FOR_GOGGLES			(ACHIEVEMENT_TF_LAST_ORANGEBOX + 5)
#define ACHIEVEMENT_TF_MELEE_KILL_CLASSIC_RIFLE_SNIPER	(ACHIEVEMENT_TF_LAST_ORANGEBOX + 6)
#define ACHIEVEMENT_TF_KILL_CHARGING_DEMO				(ACHIEVEMENT_TF_LAST_ORANGEBOX + 7)
#define ACHIEVEMENT_TF_TAUNT_DOSIDO_MELLE_KILL		(ACHIEVEMENT_TF_LAST_ORANGEBOX + 8)
#define ACHIEVEMENT_TF_TAUNT_WHILE_CAPPING			(ACHIEVEMENT_TF_LAST_ORANGEBOX + 9)
...
#define ACHIEVEMENT_TF_SNIPER_END_RANGE				1139
...
#define ACHIEVEMENT_TF_SOLDIER_AIRSTRIKE_MAX_CLIP				1239
#define ACHIEVEMENT_TF_SOLDIER_AIRSTRIKE_GROUP_KILL				1240
#define ACHIEVEMENT_TF_SOLDIER_END_RANGE						1241
...
#define ACHIEVEMENT_TF_DEMOMAN_KILL_PLAYER_YOU_DIDNT_SEE		1339
#define ACHIEVEMENT_TF_DEMOMAN_QUICK_KILLS						1340
#define ACHIEVEMENT_TF_DEMOMAN_CHARGE_KILL_CHARGING_DEMO		1341
#define ACHIEVEMENT_TF_DEMOMAN_END_RANGE						1342
